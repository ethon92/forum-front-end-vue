<template>
  <main role="main">
    <div class="album py-5 bg-light">
      <div class="container">
        <UserProfileCard :initialUserProfile="userProfile"/>
        <div class="row">
          <div class="col-md-4">
...
export default {
  ...
  methods: {
    fetchUser() {
      ...
      const { id, name, email, image, Comments, FavoritedRestaurants, Followings, Followers } = profile
      this.userProfile = {
        id,
        name,
        email,
        image,
        commentedRestaurantsCount: Comments.length,
